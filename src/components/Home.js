    ...
    return (
        <div className="flex flex-col w-full h-full flex-1">
            ...
            <p className="text-left my-10">
                Software engineer{' '}
                <a className="text-primary hover:underline" href="https://www.t-mobile.com" target="_blank" rel="noreferrer">
                    @T-Mobile
                </a>{' '}
                ...
                - Here's a{' '}
                <Link to="/resume" className="text-primary cursor-pointer hover:underline">
                    resume
                </Link>{' '}
